...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEditWrite->setGeometry(QRect(60, 230, 381, 28));
        ...
        plainTextEditRead->setGeometry(QRect(60, 350, 381, 85));
